...
[
  ...
  const decodedQuestions = rawData.map((q) => ({
  ...q,
  question: decodeURIComponent(q.question),
  correctAnswer: decodeURIComponent(q.correct_answer),
  answers: [...q.incorrect_answers.map(ans => decodeURIComponent(ans)), decodeURIComponent(q.correct_answer)].sort(() => Math.random() - 0.5)
}));

export default decodedQuestions;